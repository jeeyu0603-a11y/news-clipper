...
EXCLUDE_KEYWORDS = [
    ...
    "처벌", "징역", "벌금", "무죄", "유죄", "항소",
    "살해", "살인", "폭행", "보복", "강도", "절도", "납치", "방화", "피의자", "범행", "시신", "사망", "신고", "아비규환", "신고",
    ...
    "부사장", "지분", "인수",
    # 기타
    "종영", "중고차", "창호", "시공", "적립", "소비자추천", "연속 선정", "닮은꼴", "닮은 꼴", "성공 스토리", "[무엇이든 리뷰]", "특강", "생태계", "포토타임", 
    ...
    "MZ 톡톡", "코트라", "인터뷰", "이벤트 진행", "하차", "포럼", "투자자", "유치", "DMZ", "ET톡", "스페셜리포트", "대자보", "창업주",
    "론칭 방송", "런칭 방송", "최낙삼", "칼럼", "[이커머스 PRO]", "[무엇이든 리뷰]", "성공 스토리", "특강", "생태계",
]
STOP_WORDS = {
